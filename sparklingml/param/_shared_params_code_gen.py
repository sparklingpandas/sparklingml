...
if __name__ == "__main__":
    ...
    shared = [
        ("stopwordCase", "If the case should be considered when filtering stopwords", False, "TypeConverters.toBoolean"),
        ("stopwords",
         "Stopwords to be filtered. Default depends on underlying transformer", None, "TypeConverters.toListString")
        ]
